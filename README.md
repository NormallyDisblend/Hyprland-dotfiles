Here is your adapted README for your XFCE dotfiles repo with installation and usage instructions matching your Hyprland example, updated to download and run `run.py` from the `Xfce-Dotfiles` GitHub repo:
